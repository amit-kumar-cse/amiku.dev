    ...
    render() {
        ...
        return <div className={`card text-secondary ${classes.detailSection} shadow mb-4`}>
            <div className={`card-header ${classes.myCardHeader}`}>
                <h4 className={`card-title ${classes.textShadow} ${classes.gray}`}>I am located at</h4>
            </div>
            <div id="myMapContainer" className={`${classes.fontsSize} ${classes.cardBody} ${classes.mapsCardBody}`}>
                <GoogleMapExample
